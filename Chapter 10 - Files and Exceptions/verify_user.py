...
# Load the usernam, if it has been stored previously.
# Otherwise, prompt for the usernam and store it.
...
def greet_user():
    ...
    if username:
        username_answer = input("Is " + username.title() + " your username? yes/no ")
        if username_answer == 'yes':
