...
# 'admin'. Imagine you are writing code that will print a greeting to
# each user after they log in to a website. Loop through the list, and
...
# for log-ging in again.

users = ['frodo', 'sam', 'gandalf', 'aragorn', 'golum', 'admin']
